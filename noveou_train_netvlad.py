...
from TmirobotRender import TmirobotRender
...
class PitsSequence(keras.utils.Sequence):
    ...
    def __init__(self, PTS_BASE, nP, nN, batch_size=4, n_samples=500, initial_epoch=0, refresh_data_after_n_epochs=20, image_nrows=240, image_ncols=320, image_nchnl=1 ):
        ...
        self.pr = TmirobotRender( PTS_BASE )
...
if __name__ == '__main__':
    ...
    n_samples = 20 #< training sames to load for the epoch
    batch_size = 4  #< training batch size. aka, how many tuples must be there in 1 sample.
    refresh_data_after_n_epochs = 10  # after how many iterations you want me to refresh the data
    save_model_every_n_epochs = 50 # after every how many epochs you want me to write the models
    ...
    LOG_DIR = './models.keras/centeredinput-m1to1-%dx%dx%d__%s-%s__K%d__allpairloss' %(image_nrows, image_ncols, image_nchnl, CNN_type, layer_name, netvlad_num_clusters)
    global int_logr
    int_logr = InteractiveLogger( LOG_DIR )

    #---
    PITS_PATH = '/home/tmirobot/Documents/place-recognition/TmirobotData/Tmirobot/'
    PITS_VAL_PATH = '/home/tmirobot/Documents/place-recognition/TmirobotData/Tmirobot_validation/'
    ...
    history = t_model.fit_generator( generator = gen,
                            epochs=500, verbose=1, initial_epoch=initial_epoch,
